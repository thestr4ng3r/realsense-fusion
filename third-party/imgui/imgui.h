...
// All positions are generally in pixel coordinates (top-left at (0,0), bottom-right at io.DisplaySize), but you are totally free to apply whatever transform matrix to want to the data (if you apply such transform you'll want to apply it to ClipRect as well)
